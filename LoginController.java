...
public class LoginController {
    ...
    public String employeeLogin(Employee employee, Model model, HttpSession session) {
        ...
        if (employee1 != null) {
            ...
            return "redirect:/employee/viewClassSignups";
        }
        model.addAttribute("msg", "工号或密码错误，请重新输入！");
        return "employeeLogin";
    }
    ...
    // 跳转员工主页
    @RequestMapping("/toEmployeeMain")
    public String toEmployeeMain(Model model, HttpSession session) {
